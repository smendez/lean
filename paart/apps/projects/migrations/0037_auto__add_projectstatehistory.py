...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectStateHistory'
        db.create_table('projects_projectstatehistory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.ProjectInfo'])),
            ('datetime_entered', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 12, 17, 0, 0))),
            ('state', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('state_note', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
        ))
        db.send_create_signal('projects', ['ProjectStateHistory'])


    def backwards(self, orm):
        # Deleting model 'ProjectStateHistory'
        db.delete_table('projects_projectstatehistory')
    ...
    models = {
        ...
        'projects.project': {
            ...
            'datetime_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 17, 0, 0)'}),
        ...
        'projects.projectstatehistory': {
            ...
            'datetime_entered': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 17, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
