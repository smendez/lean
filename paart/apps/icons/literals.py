...
DELETE = 'delete'
DISK = 'disk'
DISK_ARROW_UP = 'disk_arrow_up'
DISK_ARROW_DOWN = 'disk_arrow_down'
...
INFO_RHOMBUS_DELETE = 'info_rhombus_delete'
INFO_RHOMBUS_EDIT = 'info_rhombus_edit'
...
NETWORK_ADAPTER_ADD = 'network_adapter_add'
NETWORK_ADAPTER_DELETE = 'network_adapter_delete'
NETWORK_ADAPTER_EDIT = 'network_adapter_edit'
NODE_TREE = 'node_tree'
...
THUMB_UP = 'thumb_up'
THUMB_UP_EDIT = 'thumb_up_edit'
THUMB_UP_DELETE = 'thumb_up_delete'
TICK = 'tick'
TIME = 'time'
...
WORLD_GO = 'world_go'
WRENCH = 'wrench'
WRENCH_ADD = 'wrench_add'
WRENCH_EDIT = 'wrench_edit'
WRENCH_DELETE = 'wrench_delete'
XHTML = 'xhtml'
XHTML_GO = 'xhtml_go'
XHTML_ADD = 'xhtml_add'
