...
class IconSet(IconSetBase):
    ...
    dictionary = {
        ...
        IMAGES: 'images.png',
        INDEX: 'index.png',
        INFO_RHOMBUS: 'info_rhombus.png',
        INFO_RHOMBUS_DELETE: ['info_rhombus.png', 'delete.png'],
        INFO_RHOMBUS_EDIT: ['info_rhombus.png', 'pencil.png'],
        ...
        MEASURE: 'measure.png',
        MEASURE_EDIT: ['measure.png', 'pencil.png'],
        MEASURE_DELETE: ['measure.png', 'delete.png'],
        ...
        MONEY: 'money.png',
        MONEY_EDIT: ['money.png', 'pencil.png'],
        MONEY_DELETE: 'money_delete.png',
        NETWORK_ADAPTER: 'network_adapter.png',
        NETWORK_ADAPTER_ADD: ['network_adapter.png', 'add.png'],
        NETWORK_ADAPTER_DELETE: ['network_adapter.png', 'delete.png'],
        NETWORK_ADAPTER_EDIT: ['network_adapter.png', 'pencil.png'],
        ...
        PAGE_PRINTER: ['page.png','printer.png'], 
        ...
        THUMB_UP_EDIT: ['thumb_up.png', 'pencil.png'],
        THUMB_UP_DELETE: ['thumb_up.png', 'delete.png'],
        TICK: 'tick.png',
        TIME: 'time.png',
        TIMELINE_MARKER: 'timeline_marker.png',
        TO_DO_LIST_CHEKED_1: 'to_do_list_cheked_1.png',
        TOWER: 'tower.png',
        TOWER_ADD: ['tower.png', 'add.png'],
        TOWER_EDIT: ['tower.png', 'pencil.png'],
        TOWER_DELETE: ['tower.png', 'delete.png'],
